Shader "Unlit/Card_Overlay_Shader"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                // Define a pseudo-angle for this point on the surdace, faking a curve
                ...
                // Calculate angles between light and surface
                float dotWithLight = dot(effectiveNormal, normalize(_LightVector.xyz));                  // -1 = direct Lightning, 0 = no Lightning
                ...
                // Overlay filigree on base texture
                float textureIntensitiy = _BaseLight + (filigreeGlintRatio * filigreeMaskTexColor * _FiligreeIntensity);
                
                fixed4 mainTexColor = tex2D(_MainTex, i.uv);
                return fixed4(mainTexColor.r * textureIntensitiy, mainTexColor.g * textureIntensitiy, mainTexColor.b * textureIntensitiy, mainTexColor.a);
            }
            ENDCG
        }
    }
