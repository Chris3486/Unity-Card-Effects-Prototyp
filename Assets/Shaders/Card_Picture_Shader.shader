Shader "Unlit/Card_Picture_Shader"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed4 noiseTexColor = tex2D(_NoiseTex, noiseSampleUV / _NoiseScale);
                float offsetFromNoise = float2(noiseTexColor.r-0.5, noiseTexColor.g-0.5) * _DistortionIntensity;
                ...
                // use alpha from true UV coord in main texture, but color from UV with distoration applied
